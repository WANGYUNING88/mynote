...
public class AttachController extends BaseController {
    ...
    public static final String UPLOADPATH = "D:/java/git/repository/mynote-master/";
    ...
    public APIResponse filesUploadToCloud(
        ...
        try {
            ...
            for (MultipartFile file :files) {
                ...
                System.out.println("/**************文件上传到本地开始*************/");
                System.out.println(UPLOADPATH+fileName);
                String key =  QiNiuCloudService.upload(file, fileName);
                ...
                out.close();
                System.out.println("/***********文件上传到本地结束***结果：正常*****/");
